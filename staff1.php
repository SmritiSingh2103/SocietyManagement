...
<a class="<?php echo $staff_details;?>" href="staff_details.php">View Details of Staff</a>
<a class="<?php echo $inventory;?>" href="inventory.php">Inventory</a>
<a class="<?php echo $update_stock;?>" href="update_stock.php">Update Stock</a>
